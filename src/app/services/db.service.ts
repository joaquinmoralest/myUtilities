...
export class DbService {
  ...
  perfilList = new BehaviorSubject([]);
  ...
  updatePerfil(id, perfil:Perfil){
    let data = [perfil.nombre, perfil.apellido_paterno,perfil.apellido_materno,perfil.edad,perfil.genero,perfil.ocupacion,perfil.fono,perfil.correo,perfil.deporte_favorito,perfil.red_social];
    return this.storage.executeSql(`UPDATE perfil SET nombre = ?, apellido_paterno = ?, apellido_materno = ?, edad = ?, genero = ?, ocupacion = ?, fono = ?,
